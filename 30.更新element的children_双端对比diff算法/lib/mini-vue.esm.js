    ...
    function setupRenderEffect(instance, container, anchor) {
        effect(() => {
            if (!instance.isMounted) {
                ...
                patch(prev, subTree, container, instance, anchor);
            }
        });
    }
    return {
...
export { createApp, createElement, createRenderer, createTextVnode, getCurrentInstance, h, inject, insert, isRef, patchProp, provide, proxyRefs, ref, remove, renderSlots, setElementText, unRef };
