...
//   h("p", { key: "C" }, "C"),
// ];
// const nextChildren = [h("p", { key: "B", d: '2' }, "B"), h("p", { key: "C" }, "C")];
...
export default {
    ...
    render() {
        return  this.change === true ? h('div', {}, nextChildren) : h('div', {}, prevChildren);
        ...
        //         "测试子组件之间的 patch 逻辑"
        //     ),
        //     h("children", {}, change.value === true ? nextChildren : prevChildren),
        // ]);
    },
};
